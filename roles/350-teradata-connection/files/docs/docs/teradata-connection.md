# Teradata Connection module

Module to provision a teradata connection
...
module "teradata-connection" {
  source = "github.com/Client-Engineering-Industry-Squad-1/terraform-teradata-connection"
