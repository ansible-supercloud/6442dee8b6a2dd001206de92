...
|------|-------------|---------|
| [databricks-workspace](https://github.com/Client-Engineering-Industry-Squad-1/terraform-databricks-workspace) | Module to provision a databricks workspace | v1.0.0 |
